...
在流量大时，可能 DB 就挂掉了，要是有人利用不存在的 key 频繁攻击我们的应用，这就是漏洞。如下图：[![缓存穿透](http://static2.iocoder.cn/images/Cache/2019-11-21/01.png)](http://static2.iocoder.cn/images/Cache/2019-11-21/01.png)缓存穿透
