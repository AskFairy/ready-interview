...
**push("a")/offerFirst("a") 头部插入（从队列右边塞元素：数组右边开始递减，方便popFirst）**

![image-20200916112030760](https://gitee.com//chenchong0817/picture/raw/master/Aaron/20200916112032.png)

###### **pop()/ removeFirst() 从左边弹出元素（按offerFirst入队列的顺序）**

|—— |  左底栈

###### offerLast("a") 尾部插入 （从队列左边塞元素：数组左边开始）
...
#####  removeLast() 从右边弹出（按offerLast入队的顺序拿元素）
